...
<script>
	var loc3 = firebase.database().ref('users');
	
	loc3.on('value',function(s){
		var users = s.val();
		var i = 1;
		for(user in users){
			var val = users[user];
			if(i<=4)
				document.getElementById('title'+i).innerHTML = "Distress Signal History of "+val.vno;
			i++;
		}
	});
</script>
...
<center>
<h1><center id='title1'> Distress Signal History of </center> </h1>
<table style="width:50%" id="table1">
 ...
 <h1><center id='title2'> Distress Signal History of </center> </h1>
 <table style="width:50%" id="table2">
 <thead> <tr id="tr">
    <th>Driver Name</th>
    <th>Time</th></thead>
 </table> 
 <h1><center id='title3'> Distress Signal History of </center> </h1>
 <table style="width:50%" id="table3">
  <thead><tr id="tr">
    <th>Driver Name</th>
    <th>Time</th></thead>
 </table> 
 <h1><center id='title4'> Distress Signal History of </center> </h1>
 <table style="width:50%" id="table4">
 <thead> <tr id="tr">
    <th>Driver Name</th>
    <th>Time</th></thead>
 </table> 
...
<script>
    ...
    var database = firebase.database().ref('alarm_history/'+1);
	...
	var database2 = firebase.database().ref('alarm_history/'+2);
	...
	var database3 = firebase.database().ref('alarm_history/'+3);
    database3.on('value', function(snapshot){
        if(snapshot.exists()){
            var content = '';
			var drivers = snapshot.val();
			for(driver in drivers){
            ...
            $('#table3').append(content);
			
        }
		//location.reload();
    });
	
	var database4 = firebase.database().ref('alarm_history/'+4);
    database4.on('value', function(snapshot){
        if(snapshot.exists()){
            var content = '';
			var drivers = snapshot.val();
			for(driver in drivers){
